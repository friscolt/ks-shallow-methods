...
% writetable(t__results,'results_num_patch_bru_sec.xlsx') % Test
    ...
    if isfile(gt_name)
        ...
        if(mI == mgt && nI==ngt)
            ...
            for overlap = 20:10:100
                ...
                T = table(j,categorical({type_stone}),{dir_name},percent_pixels_gt,npatch,overlap,wsize,per,'VariableNames',{'Index','Folder','Name','Percent','nPatches','Overlap','Window','perStone'});
